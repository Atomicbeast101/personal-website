...
ENV HUGO_BASEURL=''
ENV HUGO_TITLE=''
ENV HUGO_PARAMS_AUTHOR=''
ENV HUGO_PARAMS_DESCRIPTION=''
ENV HUGO_PARAMS_KEYWORDS=''
ENV HUGO_PARAMS_INFO=''
ENV HUGO_PARAMS_AVATARURL=''
ENV HUGO_PARAMS_COLORSCHEME=''
ENV HUGO_PARAMS_UMAMI_ENABLED=''
ENV HUGO_PARAMS_UMAMI_WEBSITEID=''
ENV HUGO_PARAMS_UMAMI_JSLOCATION=''
ENV HUGO_SOCIAL_EMAIL=''
ENV HUGO_SOCIAL_LINKEDIN=''
ENV HUGO_SOCIAL_GITHUB=''
ENV HUGO_RESUME=''
